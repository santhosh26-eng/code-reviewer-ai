...
LANGUAGE_SIGNATURES: Dict[str, List[str]] = {
    ...
    "C#": [r"\busing\s+System;", r"\bConsole\.WriteLine", r"\bnamespace\s+[a-zA-Z0-9_]+"],
    "Python": [r"\bdef\s+[a-zA-Z0-9_]+", r"\bimport\s+[a-zA-Z0-9_]+", r"^\s*print\(", r"\bclass\s+[a-zA-Z0-9_]+.*:"],
    "JavaScript/TypeScript": [r"\bconsole\.log\(", r"\bconst\s+[a-zA-Z0-9_]+", r"\blet\s+[a-zA-Z0-9_]+", r"\bfunction\s+[a-zA-Z0-9_]+"],
    "Go": [r"\bfunc\s+[a-zA-Z0-9_]+", r"\bpackage\s+main\b", r"\bfmt\.Println"],
    ...
    "Verilog": [r"\bmodule\s+[a-zA-Z0-9_]+", r"\balways\s*@", r"\bendmodule\b"],
    ...
    "PLC Structured Text": [r"\bPROGRAM\s+[a-zA-Z0-9_]+", r"\bEND_PROGRAM\b", r"\bVAR\b", r"\bEND_VAR\b", r":=\s*"]
}
